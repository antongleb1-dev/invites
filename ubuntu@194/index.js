...
var weddings = mysqlTable("weddings", {
  ...
  showHeart: boolean("showHeart").default(true),
  // Show/hide heart icon on wedding page
...
var appRouter = router({
  ...
  wedding: router({
    ...
    update: protectedProcedure.input(z2.object({
      ...
      descriptionKz: z2.string().optional(),
      backgroundImage: z2.string().optional(),
      customBackgroundUrl: z2.string().optional(),
      photoShape: z2.enum(["square", "circle", "heart", "hexagon", "diamond", "arch", "frame"]).optional(),
  ...
  gallery: router({
    ...
    add: protectedProcedure.input(z2.object({
      ...
      if (!wedding.isPaid) {
        throw new TRPCError3({
          code: "FORBIDDEN",
          message: "\u0413\u0430\u043B\u0435\u0440\u0435\u044F \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430 \u0442\u043E\u043B\u044C\u043A\u043E \u0432 \u043F\u043B\u0430\u0442\u043D\u043E\u0439 \u0432\u0435\u0440\u0441\u0438\u0438"
        });
      }
      ...
      if (db) {
        ...
        if (existingUsers.length > 0) {
          ...
          const result = await db.insert(users).values({
            ...
            // User accepted terms during registration
          });
