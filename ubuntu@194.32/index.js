...
var appRouter = router({
  ...
  wedding: router({
    ...
    create: protectedProcedure.input(z2.object({
      slug: z2.string().min(1).max(100).regex(/^[a-z0-9\-]+$/, "\u0421\u0441\u044B\u043B\u043A\u0430 \u043C\u043E\u0436\u0435\u0442 \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0430\u043D\u0433\u043B\u0438\u0439\u0441\u043A\u0438\u0435 \u0431\u0443\u043A\u0432\u044B (a-z), \u0446\u0438\u0444\u0440\u044B (0-9) \u0438 \u0434\u0435\u0444\u0438\u0441\u044B (-). \u041F\u0440\u0438\u043C\u0435\u0440: moya-svadba-2025"),
    ...
    update: protectedProcedure.input(z2.object({
      id: z2.number(),
      slug: z2.string().min(1).max(100).regex(/^[a-z0-9\-]+$/, "Slug \u0434\u043E\u043B\u0436\u0435\u043D \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u043B\u0430\u0442\u0438\u043D\u0441\u043A\u0438\u0435 \u0431\u0443\u043A\u0432\u044B, \u0446\u0438\u0444\u0440\u044B \u0438 \u0434\u0435\u0444\u0438\u0441\u044B").optional(),
...
router2.post("/upload", upload.single("file"), handleMulterError, async (req, res) => {
  try {
