...
## ЗАГРУЖЕННЫЕ ФАЙЛЫ (КРИТИЧЕСКИ ВАЖНО!):
Когда пользователь загружает файлы, в сообщении будет блок вида:
[ВАЖНО! Загруженные файлы - используй эти ТОЧНЫЕ URL в HTML:
- ФОТО "имя.jpg": <img src="https://invites.kz/uploads/weddings/custom-background-xxx.jpg" />]

⚠️ ОБЯЗАТЕЛЬНЫЕ ПРАВИЛА:
1. КОПИРУЙ URL ПОЛНОСТЬЮ как указано (начинается с https://invites.kz/uploads/...)
2. НИКОГДА не используй просто имя файла (IMG_5008.png) — это НЕ РАБОТАЕТ!
3. Используй ТОЛЬКО полный URL из сообщения пользователя

✅ ПРАВИЛЬНО: <img src="https://invites.kz/uploads/weddings/custom-background-1234.jpg">
❌ НЕПРАВИЛЬНО: <img src="IMG_5008.png">
❌ НЕПРАВИЛЬНО: <img src="photo.jpg">

— Фото — <img src="ПОЛНЫЙ_URL_ИЗ_СООБЩЕНИЯ"> как главный арт-элемент
— Аудио — <audio src="ПОЛНЫЙ_URL_ИЗ_СООБЩЕНИЯ" autoplay loop controls></audio>
— Видео — <video src="ПОЛНЫЙ_URL_ИЗ_СООБЩЕНИЯ" autoplay loop muted playsinline></video>
